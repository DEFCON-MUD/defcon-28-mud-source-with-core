...
syspath = "/home/gurba/defcon-28-mud-source-with-core/lib/domains/sewer/rooms/"
domain = "../domain.h"
...
mobs = ["Gl0Rz0", "agent", "alexis", "analyst", "andy", "angryweevil", "anthonyfox", "antoinnete", "arnie", "atriumrat", "auditor", "autobot", "autod", "baboon", "banker", "bartender", "biddleman", "billy", "blob", "boa", "boar", "bob", "bol", "bouer", "bouer2", "brian", "buddypetersen", "bugsy", "cagedaer", "captain", "carrierpigeon", "carson", "cellguard", "child", "clara", "clerk", "clubbouer", "clubdaer", "ckroh", "coder", "colleen", "constrtor", "craig", "ccagent", "captain", "culprit", "cyberslime", "clophant", "daer", "dba", "debra", "deformedweevil", "doe", "domeguard", "droid", "drone", "eastauthorizer", "easlerk", "eastfilinlerk", "eastformatter", "eastmaintenaedroid", "edwardio", "enfoer", "er", "evilown", "fern", "ferret", "fieldmouse", "fireant", "floorvine", "freddy", "gana", "glorzo", "goldfish", "goon", "gorilla", "greenslime", "greensnake", "groupie", "grunt", "guard", "hans", "hkle", "heptosquid", "hore", "housingoffer", "iguana", "jkbk", "jkie", "job", "james", "japanesebeetle", "jeff", "jenny", "john", "johnson", "josef", "kavi", "ken", "kendall", "koreth", "largeheptopsquid", "largeheptosquid", "leader", "lil", "log", "loser", "lrak", "lulams", "lyndia", "magnus", "maintainer", "maintenaedroid", "mamba", "manny", "massiveweevil", "maxim", "mei", "mike", "mila", "monitor", "monkey", "monzema", "mosquito", "mutatekroh", "neelo", "norman", "northdomeguard", "offer", "olasha", "outfitterrobot", "panther", "pasties", "peter", "planner", "poledaer", "politian", "pottles", "powerdrone", "prisonfreddie", "prisonguard", "probe", "professor", "python", "queenrat", "queenslug", "r1alan", "r1alan.bak", "rarmella", "r1elaine", "r1engineer", "r1hannah", "r1mandrone", "r1marilynn", "r1physist", "r1radiologist", "r1radsensor", "r1serveman", "r1zerky", "rhel", "raddgoo", "raddyzoon", "radgoo", "randy", "rat", "ratqueen", "rattlesnake", "repairdroid", "rk", "roger", "salesdroid", "salik", "sandworm", "surityoffer", "sewerboss", "shelledheptosquid", "slime", "slowzombie", "slug", "smallweevil", "snake", "snapperjaw", "sparrow", "steve", "stoner", "tangleweed", "tawny", "teher", "th", "thnian", "tiffany", "tinyweevil", "tom", "torga", "treelizard", "ursula", "valerie", "vampire", "varysstark", "vern", "vipbouer", "vlarapp", "vonnewman", "wardenbrke", "warrior", "wasteworm", "watersnake", "weevil", "wellin", "wendall", "wendy", "x", "zaryem", "zombie"]
