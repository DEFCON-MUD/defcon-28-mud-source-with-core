...
mobs = ["Gl0Rz0","agent","alexis","analyst","andy","angryweevil","anthonyfox","antoinnete","arnie","atriumrat","auditor","autobot","autodoc","baboon","banker","bartender","biddleman","billy","blob","boa","boar","bob","bol","bouncer","bouncer2","brian","buddypetersen","bugsy","cagedancer","captain","carrierpigeon","carson","cellguard","child","clara","clerk","clubbouncer","clubdancer","cockroach","coder","colleen","constrictor","craig","csccagent","cscccaptain","culprit","cyberslime","cyclophant","dancer","dba","debra","deformedweevil","doe","domeguard","droid","drone","eastauthorizer","eastclerk","eastfilingclerk","eastformatter","eastmaintenancedroid","edwardio","enforcer","eric","evilclown","fern","ferret","fieldmouse","fireant","floorvine","freddy","gana","glorzo","goldfish","goon","gorilla","greenslime","greensnake","groupie","grunt","guard","hans","heckle","heptosquid","horace","housingofficer","iguana","jackback","jackie","jacob","james","japanesebeetle","jeff","jenny","john","johnson","josef","kavi","ken","kendall","koretech","largeheptopsquid","largeheptosquid","leader","lil","log","loser","lrak","lulams","lyndia","magnus","maintainer","maintenancedroid","mamba","manny","massiveweevil","maxim","mei","mike","mila","monitor","monkey","monzema","mosquito","mutatedcockroach","neelo","norman","northdomeguard","officer","olasha","outfitterrobot","panther","pasties","peter","planner","poledancer","politician","pottles","powerdrone","prisonfreddie","prisonguard","probe","professor","python","queenrat","queenslug","r1alan","r1carmella","r1elaine","r1engineer","r1hannah","r1mandrone","r1marilynn","r1physicist","r1radiologist","r1radsensor","r1serviceman","r1zerky","rachel","raddgoo","raddyzoon","radgoo","randy","rat","ratqueen","rattlesnake","repairdroid","rick","roger","salesdroid","salik","sandworm","securityofficer","sewerboss","shelledheptosquid","slime","slowzombie","slug","smallweevil","snake","snapperjaw","sparrow","steve","stoner","tangleweed","tawny","teacher","tech","technician","tiffany","tinyweevil","tom","torga","treelizard","ursula","valerie","vampire","varysstark","vern","vipbouncer","vlarapp","vonnewman","wardenbrocke","warrior","wasteworm","watersnake","weevil","wellin","wendall","wendy","zaryem","zombie"]
...
l_desc_option_list_1d = ['gunk', 'sludge', 'muck', 'crud', 'crap', 'radioactive waste', 'crappy sales material', 'random junk evilmog thought up', 'glorzo', 'pile of put kevin back stickers', 'pile of GPUs that burned so bright they went radioactive']
...
if args.south is not None:
    exits.append(["south", "x" + coords[0] + "y" + str(int(coords[1]) - 1) + "z" + coords[2]])
    exit_list.append(["west"])
...
roomfile.write('set_objects( DIR+"/npc/' + random.choice(mobs) + '.c");\n')
